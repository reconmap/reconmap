...
- Added secret-safe API startup diagnostics for listener and dependency configuration, plus explicit lifecycle logs when startup is cancelled or the host stops.
