...
The file is now on the system and will be processed in the background. Findings and assets found in the scan output file are created automatically on the selected Reconmap project.
